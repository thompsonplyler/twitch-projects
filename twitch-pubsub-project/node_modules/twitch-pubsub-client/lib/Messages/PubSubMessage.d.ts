...
declare type PubSubMessageData = PubSubBitsMessageData | PubSubBitsBadgeUnlockMessageData | PubSubChatModActionMessageData | PubSubSubscriptionMessageData | PubSubWhisperMessageData;
export { PubSubMessageData };
declare type PubSubMessage = PubSubBitsMessage | PubSubBitsBadgeUnlockMessage | PubSubChatModActionMessage | PubSubSubscriptionMessage | PubSubWhisperMessage;
